...
from poa.data.transforms import make_classification_eval_transform, make_classification_train_transform
import poa.distributed as distributed
from poa.eval.metrics import MetricType, build_metric
from poa.eval.setup import get_args_parser as get_setup_args_parser
from poa.eval.setup import setup_and_build_model
from poa.eval.utils import ModelWithIntermediateLayers, evaluate
...
if __name__ == "__main__":
    description = "POA linear evaluation"
