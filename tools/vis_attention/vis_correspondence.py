...
def main():
    ...
    parser.add_argument("--show_pics", type=bool, default=True)
    parser.add_argument("--show_with_attn", type=bool, default=False)
    parser.add_argument("--show_nums", type=int, default=300)
